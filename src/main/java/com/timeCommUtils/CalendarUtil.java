...
public class CalendarUtil {
     ...
     * @param m
     * @param d
     * @return  返回  eg：农历年历：4711 (甲午 - 马年)  四月初三
     */
    public static String getTime(int y,int m,int d){
        CalendarUtil c = new CalendarUtil();
        c.setGregorian(y, m, d);
        String[] a=c.getYearTable();
        String contentTime=a[1]+c.getChineseMonth(y, m, d)+c.getChineseDay(y,m, d);
        return contentTime;
    }
    ...
    public static void main(String[] arg) {
        ...
        int d = 11;
        	...
        	System.out.println(c.getMonthTable().toString());

        c.setGregorian(y, m, d);
        //c.computeChineseFields();
        //c.computeSolarTerms();
        String[] a=c.getYearTable();
        String[] b=c.getMonthTable();


        System.out.println(getTime(y, m, d));
		System.out.println(a[1]);

		System.out.println("==============农历日期=====================");

		System.out.println(c.getChineseYear()+c.getChineseMonth(2014, 5, 1)+c.getChineseDay(2014, 5, 1));
